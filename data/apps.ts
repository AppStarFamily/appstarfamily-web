...
export const apps: App[] = [
  ...
  {
    slug: 'lyrical',
    name: 'Dynamic Lyrics — Lyrical',
    tagline: 'Your lyrics everywhere. Dynamic Island. Lock Screen. CarPlay.',
    description: 'Real-time synced lyrics for Apple Music and Spotify, displayed across Dynamic Island, Lock Screen, CarPlay and widgets. Karaoke-style syllable highlighting, K-pop romanization, and haptic feedback.',
    category: 'music',
    status: 'coming-soon',
  ...
  {
    slug: 'color-by-number-ai',
    name: 'Color By Number with AI',
    tagline: 'Turn any photo into a paint-by-numbers canvas.',
    description: 'Upload any photo and watch AI transform it into a beautiful color-by-number artwork. Meditative, creative, and surprisingly addictive. Perfect for unwinding after a long day.',
    category: 'fun',
    status: 'coming-soon',
    icon: '/images/apps/color-by-number-ai.webp',
    featured: false,
    markets: ['Global'],
  },
  {
    slug: 'romanization-lyrics',
    name: 'Romanization Lyrics',
    tagline: 'Sing along to K-pop. No Korean required.',
    description: 'Real-time romanization for Korean, Japanese and Chinese lyrics. Follow along phonetically with any song in Apple Music or Spotify. Built for K-pop fans who want to sing every word, not just the chorus.',
    category: 'music',
    status: 'coming-soon',
    icon: '/images/apps/romanization-lyrics.webp',
    featured: false,
    markets: ['Global'],
  },
]
